...
const Nav = ({
  ...
  return (
    <header>
      <nav className="fade-in flex items-center min-w-[375px] w-full border-b border-darksecondary bg-lghtsecondary ">
        <div className="flex flex-row items-center z-[1] ">
          ...
          <div className="tb:w-[260px] dk:w-[300px] items-center flex tb:border-r border-darksecondary p-4 h-[64px] tb:h-[80px] dk:h-[96px] ">
            ...
            <h1 className="ml-4 hidden tb:inline-block font-bold text-[1.85rem] tracking-[.3px] text-lghttext">
          ...
          <div className="flex flex-row p-4 dk:px-8">
            <h2 className=" fade-in truncate max-w-[250px] font-bold tb:text-l hidden tb:inline-block dk:text-xl text-lghttext">
            ...
            >
              <h2 className=" fade-in truncate max-w-[200px] font-bold tb:text-l dk:text-xl text-lghttext">
                {boards.length < 1 ? "No Boards" : board.name}
              </h2>
        ...
        {boards.length < 1 ? (
          ...
          <div className="relative ml-auto flex flex-row gap-[.5rem] z-[1] p-4 dk:px-8 dk:gap-[1.5rem]">
            {/* Add a task */}
            <button
              onClick={() => {
                setNewTaskMenu(true);
              ...
              className="bg-lghtaccent hover:bg-accent-300 px-4 py-3 rounded flex items-center shadow-md"
            >
            ...
            <button onClick={() => setElippsesMenu(!ellipsesMenu)}>
              <MoreVertTwoToneIcon sx={{ fontSize: "2rem" }} className='text-lghttext'/>
            </button>
          </div>
        )}
      </nav>
